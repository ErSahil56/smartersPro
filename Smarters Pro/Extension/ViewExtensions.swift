...
extension UIView {
    ...
    func gradientView() {
//        let gradientLayer = Gradients.linear(to: Direction.bottom, colors: [UIColor.black.withAlphaComponent(0.2).cgColor, UIColor.black.withAlphaComponent(0.3).cgColor], locations: [0.0,1.0])
...
//                self.imageCompletion?(pickedImage,nil)
//            } else if let videoUrl = info[UIImagePickerController.InfoKey.mediaURL] as? URL {
//                self.imageCompletion?(nil,videoUrl)
//            }
//        }else{
